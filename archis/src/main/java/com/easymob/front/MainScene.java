...
import com.easymob.bdd.MetamobCrud;
...
import com.easymob.ocr.ScreenCapture;
...
public class MainScene implements SettingsUpdateListener, ScreenCaptureListener {
    ...
    public static void main(String[] args) throws UnsupportedLookAndFeelException, IOException {
        ...
        //set the app icon with img/logoPdaArchi.png

        Logger logger = Logger.getLogger(GlobalScreen.class.getPackage().getName());
        logger.setLevel(Level.OFF);
        JFrame.setDefaultLookAndFeelDecorated(true);
        JFrame frame = new JFrame("EasyMob");
        frame.setIconImage(ImageIO.read(MainScene.class.getResourceAsStream("/img/logoPdaArchi.png")));
        frame.setUndecorated(true);
